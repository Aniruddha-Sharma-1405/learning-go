...
type DeleteUserUserIDHandlerFunc func(DeleteUserUserIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteUserUserIDHandlerFunc) Handle(params DeleteUserUserIDParams) middleware.Responder {
	return fn(params)
}
...
type DeleteUserUserIDHandler interface {
	Handle(DeleteUserUserIDParams) middleware.Responder
}
